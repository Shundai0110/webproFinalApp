...
| 最終更新日     | 2026-7-31                                     |
| バージョン     | beta                                          |
| リポジトリURL  | https://github.com/Shundai0110/webproFinalApp |
| デプロイ先     | Render.com                                    |
| 本番URL        | https://keio-book-demo.onrender.com/          |
...
async function approveTransaction(
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const nextBuyerApproved =
      currentUserId === transaction.buyerId ? true : transaction.buyerApproved;
